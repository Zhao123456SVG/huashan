...
<div id="content" class="white">
		<h1><img src="/qlgw/Public/images/posts.png" alt="">公司资质管理</h1>
		<div class="bloc">
				<div class="title"> 操作 <a class="toggle"></a></div>
				<div class="content dashboard">
						<div class="center" style="display: block; width: auto;"> 
						 <a href="/qlgw/index.php/Admin/Index/zz_add" class="shortcut zoombox w500 h380"> <img src="/qlgw/Public/images/glyph-add.png" alt="" width="48" height="48"> 添加产品分类 </a> 
								<div class="cb"></div>
		...
		<div class="bloc">
				...
				<div class="content">
						<table>
								...
								<tbody>
									<?php if(is_array($zz)): foreach($zz as $key=>$v): ?><tr>
												...
												<a href="/qlgw/index.php/Admin/Index/zz_add_update?id=<?php echo ($v["id"]); ?>" title="修改">
												<img src="/qlgw/Public/images/edit.png" alt=""></a>
												<a href="/qlgw/index.php/Admin/Index/zz_add_del?id=<?php echo ($v["id"]); ?>" title="删除">
