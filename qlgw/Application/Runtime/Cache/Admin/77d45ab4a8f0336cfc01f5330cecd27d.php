...
<div id="content" class="white">
		...
		<div class="bloc">
				...
				<div class="content">
						<form action="/qlgw/index.php/Admin/Index/ours_add_update" method="post" enctype="multipart/form-data">
						<div class="input">
						...
						<div class="input">
								...
								<input type="text" name="detail" id="input1" value="<?php echo ($res["detail"]); ?>">
						</div>
						...
						<div class="input textarea">
								...
								<textarea name="detail1" id="textarea1" rows="7" cols="4"><?php echo ($res["detail1"]); ?></textarea>
						</div>
						<div class="input">
								<label for="file">地址</label>
								<input type="text" name="address" id="input1" value="<?php echo ($res["address"]); ?>">
						</div>
						<div class="input textarea">
								<label for="textarea1">邮箱</label>
								<textarea name="email" id="textarea1" rows="7" cols="4"><?php echo ($res["email"]); ?></textarea>
						</div>
						<div class="input textarea">
								<label for="textarea1">手机</label>
								<textarea name="phone" id="textarea1" rows="7" cols="4"><?php echo ($res["phone"]); ?></textarea>
						</div>
						<div class="input textarea">
								<label for="textarea1">手机</label>
								<textarea name="mobile" id="textarea1" rows="7" cols="4"><?php echo ($res["mobile"]); ?></textarea>
						</div>
