...
<div id="content" class="white" >
		<div class="bloc">
				...
				<div class="content">
						<form action="/qlgw/index.php/Admin/Index/example_add_insert" method="post" enctype="multipart/form-data">
						<div class="input">
						...
						<div class="input textarea">
								...
								<textarea name="cont1" id="textarea1" rows="7" cols="4"></textarea>
						</div>
						<div class="input textarea">
						...
						<div class="input textarea">
								<label for="textarea1">分类图片内容</label>
								<input type="text" name="image_title" id="input1">
						</div>
						<div class="input textarea">
								<label for="textarea1">子内容</label>
								<textarea name="cont2" id="textarea1" rows="7" cols="4"></textarea>
						</div>
						<div class="submit">
