...
<div id="content" class="white" >
		<div class="bloc">
				...
				<div class="content">
						<form action="/qlgw/index.php/Admin/Index/computer_add_insert" method="post" enctype="multipart/form-data">
						<div class="input">
						...
						<div class="input textarea">
								<label for="textarea1">子内容1</label>
								<textarea name="cont3" id="textarea1" rows="7" cols="4"></textarea>
						</div>
						<div class="submit">
