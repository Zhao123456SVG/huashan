...
<div id="content" class="white">
		<h1><img src="/qlgw/Public/images/posts.png" alt="">分类管理</h1>
		<div class="bloc">
				<div class="title"> 操作 <a class="toggle"></a></div>
				<div class="content dashboard">
						<div class="center" style="display: block; width: auto;"> 
						 <a href="/qlgw/index.php/Admin/Index/one_menu_add" class="shortcut zoombox w500 h380"> <img src="/qlgw/Public/images/glyph-add.png" alt="" width="48" height="48"> 添加分类 </a> 
								<div class="cb"></div>
						...
						<table>
								...
								<tbody>
									<?php if(is_array($menu)): foreach($menu as $key=>$v): ?><tr>
												...
												<td><?php echo ($v["id"]); ?></td>
												<td><?php echo ($v["procuct"]); ?></td>
												<td>
												<a href="/qlgw/index.php/Admin/Index/one_menu_update?id=<?php echo ($v["id"]); ?>" title="修改">
												<img src="/qlgw/Public/images/edit.png" alt=""></a>
												<a href="/qlgw/index.php/Admin/Index/one_menu_del?id=<?php echo ($v["id"]); ?>" title="删除">
