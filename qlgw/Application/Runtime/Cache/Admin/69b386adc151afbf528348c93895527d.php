...
<div id="content" class="white">
		...
		<div class="bloc">
				...
				<div class="content">
						<form action="/qlgw/index.php/Admin/Index/computer_add_update" method="post" enctype="multipart/form-data">
						<div class="input">
						...
						<div class="input">
								<label for="file">分类图片标题</label>
								<input type="text" name="cont2" id="input1" value="<?php echo ($res["cont2"]); ?>">
						</div>
						<div class="input textarea">
								<label for="textarea1">内容</label>
								<textarea name="cont3" id="textarea1" rows="7" cols="4"><?php echo ($res["cont3"]); ?></textarea>
						</div>
