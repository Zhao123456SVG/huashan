		...
		<div class="bloc">
				...
				<div class="content dashboard">
						<div class="center" style="display: block; width: auto;"> 
						 <a href="/qlgw/index.php/Admin/Index/example_add" class="shortcut zoombox w500 h380"> <img src="/qlgw/Public/images/glyph-add.png" alt="" width="48" height="48"> 添加产品分类 </a> 
								<div class="cb"></div>
		...
		<div class="bloc">
				...
				<div class="content">
						<table>
								...
								<tbody>
									<?php if(is_array($example)): foreach($example as $key=>$v): ?><tr>
												
												<td><?php echo ($v["id"]); ?></td>
												<td><?php echo ($v["title"]); ?></td>
												<td><?php echo ($v["produce"]); ?></td>
												<td><?php echo ($v["cont1"]); ?></td>
												<td><img src="/qlgw/Public/<?php echo ($v["image"]); ?>" style="width:20%;height:50%;" /></td>
												<td><?php echo ($v["cont2"]); ?></td>
												<td>
												
												<a href="/qlgw/index.php/Admin/Index/example_add_update?id=<?php echo ($v["id"]); ?>" title="修改">
												<img src="/qlgw/Public/images/edit.png" alt=""></a>
												<a href="/qlgw/index.php/Admin/Index/example_add_del?id=<?php echo ($v["id"]); ?>" title="删除">
