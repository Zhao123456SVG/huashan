...
<div id="content" class="white" >
		<div class="bloc">
				...
				<div class="content">
						<form action="/qlgw/index.php/Admin/Index/product_add_insert" method="post" enctype="multipart/form-data">
						<div class="input">
						...
						<div class="input textarea">
								...
								<input type="text" name="produce" id="input1">
						...
						<div class="input textarea">
								<label for="textarea1">分类图片标题</label>
								<input type="text" name="img_title" id="input1">
							<!-- 	<textarea name="text" id="textarea1" rows="7" cols="4"></textarea> -->
						</div>
						<div class="input textarea">
								<label for="textarea1">分类图片详情</label>
								<input type="text" name="img_detail" id="input1">
							<!-- 	<textarea name="text" id="textarea1" rows="7" cols="4"></textarea> -->
						</div>
						<div class="input">
								<label for="file">分类图片</label>
						...
						<div class="input textarea">
								<label for="textarea1">分类图片标题</label>
								<input type="text" name="img1_title" id="input1">
							<!-- 	<textarea name="text" id="textarea1" rows="7" cols="4"></textarea> -->
						</div>
						<div class="input textarea">
								<label for="textarea1">分类图片详情</label>
								<input type="text" name="img1_detail" id="input1">
							<!-- 	<textarea name="text" id="textarea1" rows="7" cols="4"></textarea> -->
						</div>
