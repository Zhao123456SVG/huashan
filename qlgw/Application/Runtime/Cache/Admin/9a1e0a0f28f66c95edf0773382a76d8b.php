		...
		<div class="bloc">
				...
				<div class="content dashboard">
						<div class="center" style="display: block; width: auto;"> 
						 <a href="/qlgw/index.php/Admin/Index/computer_add" class="shortcut zoombox w500 h380"> <img src="/qlgw/Public/images/glyph-add.png" alt="" width="48" height="48"> 添加产品分类 </a> 
								<div class="cb"></div>
						...
						<table>
								...
								<tbody>
									<?php if(is_array($computer)): foreach($computer as $key=>$v): ?><tr>
												...
												<td><?php echo ($v["cont3"]); ?></td>
												<td>
												
												<a href="/qlgw/index.php/Admin/Index/computer_add_update?id=<?php echo ($v["id"]); ?>" title="修改">
												<img src="/qlgw/Public/images/edit.png" alt=""></a>
												<a href="/qlgw/index.php/Admin/Index/computer_add_del?id=<?php echo ($v["id"]); ?>" title="删除">
