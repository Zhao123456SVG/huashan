...
<div id="content" class="white">
		...
		<div class="bloc">
				...
				<div class="content">
						<form action="/qlgw/index.php/Admin/Index/sylb_update" method="post" enctype="multipart/form-data">
						<div class="input">
						...
						<div class="input">
								...
								<input type="text" name="content" id="input1" value="<?php echo ($res["content"]); ?>">
						</div>
						...
						<div class="input">
								<label for="file">分类图片</label>
								<div class="uploader" id="uniform-file">
										<input name="img2" type="file" id="file" size="20" style="opacity: 0;">
										<span class="filename"></span><span class="action">请选择图片</span></div>
						</div>
						<div class="input">
								<label for="file">分类图片</label>
								<div class="uploader" id="uniform-file">
										<input name="img3" type="file" id="file" size="20" style="opacity: 0;">
										<span class="filename"></span><span class="action">请选择图片</span></div>
						</div>
