...
<div id="content" class="white" >
		<div class="bloc">
				...
				<div class="content">
						<form action="/qlgw/index.php/Admin/Index/ours_add_insert" method="post" enctype="multipart/form-data">
						<div class="input">
						...
						<div class="input">
								<label for="file">副标题</label>
								<input type="text" name="detail1" id="input1">
						</div>
						<div class="input">
								<label for="file">地址</label>
								<input type="text" name="address" id="input1">
						</div>
						<div class="input">
								<label for="file">邮箱</label>
								<input type="text" name="email" id="input1">
						</div>
						<div class="input">
								<label for="file">联系人手机号</label>
								<input type="text" name="phone" id="input1">
						</div>
						<div class="input">
								<label for="file">座机</label>
								<input type="text" name="mobile" id="input1">
						</div>
						<div class="input textarea">
