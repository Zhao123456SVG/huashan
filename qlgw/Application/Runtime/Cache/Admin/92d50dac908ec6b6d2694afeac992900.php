...
<div id="content" class="white">
		...
		<div class="bloc">
				...
				<div class="content">
						<form action="/qlgw/index.php/Admin/Index/zz_add_update" method="post" enctype="multipart/form-data">
						<div class="input">
						...
						<div class="input">
								...
								<input type="text" name="cont" id="input1" value="<?php echo ($res["cont"]); ?>">
						</div>
