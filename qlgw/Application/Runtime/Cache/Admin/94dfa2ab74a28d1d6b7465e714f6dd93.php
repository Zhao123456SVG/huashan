...
<div id="content" class="white">
		...
		<div class="bloc">
				...
				<div class="content">
						<form action="/qlgw/index.php/Admin/Index/company_add_update" method="post" enctype="multipart/form-data">
						<div class="input">
						...
						<div class="input textarea">
								...
								<textarea name="content" id="textarea1" rows="7" cols="4"><?php echo ($res["content"]); ?></textarea>
						</div>
